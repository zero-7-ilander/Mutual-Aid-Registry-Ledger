...
- `SUMMARY.md` — one-line as-of snapshot (rows / active / entry-pending / departed, claims filed vs paid-and-closed), regenerated on every money-sweep apply. Point cold readers here first; `ledger.json` is the source.
